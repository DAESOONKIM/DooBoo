...
<script>
let msg = "${msg}";
if(msg=="PASS_ERR")  alert("패스워드가 다릅니다 확인해주세요.");
...
<!-- Page content-->
<form id="contactForm" data-sb-form-api-token="API_TOKEN" action="<c:url value="/board/write"/>" method="post">
				...
				<p>The table is free</p>
                    ...
                    <div class="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
                        <div class="text-center mb-5">
                            ...
                            <h1 class="fw-bolder">Get it write</h1>
                        ...
                        <div class="row gx-5 justify-content-center">
                            <div class="col-lg-8 col-xl-6">
                                ...
                                <!-- to get an API token!-->
                                    ...
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="password_chk" name="password_chk" type="password" placeholder="Enter your password..." data-sb-validations="required" />
                                        <label for="subject">password check</label>
                                        <div class="invalid-feedback" data-sb-feedback="password:required">A password is required.</div>
                                    </div>
                                    <!-- content input-->
                                    <div class="form-floating mb-3">
                                    ...
                                    <!-- Submit Button-->
                                  <div class="d-grid"><input class="btn btn-primary btn-lg" value="Submit" type="submit"></div>
                    ...
                    <div class="row gx-5 row-cols-2 row-cols-lg-4 py-5">
                        <div class="col">
                            <button type="button" class="btn btn-primary btn-lg rounded-3 mb-3" onclick="location.href='FreeBoardCon.do'"><i class="bi bi-list"></i></button>
                             <br/>
