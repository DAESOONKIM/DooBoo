...
<script>
let msg = "${msg}";
if(msg=="MAIL_FAIL")  alert("메일을 발송하는데 실패했습니다. 다시 시도해 주세요.");
if(msg=="MAIL_SUCCESS")  alert("성공적으로 메일이 발송되었습니다.");
</script>
							...
							<div class="col-lg-8 col-xl-6">
								...
								<div class="form-floating mb-3">
									<input class="form-control" id="subject" name="subject"
										...
										data-sb-validations="required" /> <label for="subject">Title</label>
									<div class="invalid-feedback"
										data-sb-feedback="subject:required">A title is required.</div>
								</div>
								<!-- email input-->
								<div class="form-floating mb-3">
									<input class="form-control" id="receiver" name="receiver"
										type="text" placeholder="Enter your email..."
										data-sb-validations="required" /> <label for="receiver">email</label>
								...
								<div class="form-floating mb-3">
									<input class="form-control" id="number" name="number"
										...
										data-sb-validations="required" /> <label for="number">number</label>
									<div class="invalid-feedback"
										data-sb-feedback="number:required">A number is required.</div>
								</div>
								<!-- content input-->
								<div class="form-floating mb-3">
								...
								<!-- Submit Button-->
								<div class="d-grid">
									<input class="btn btn-primary btn-lg" value="Submit"
										type="submit">
								</div>
